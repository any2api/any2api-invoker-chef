  ...
  obj.invoke = function(args, done) {
    ...
    var install = function(done) {
      ...
      async.series([
        ...
        //TODO: this should be 'move' instead of 'copy' for efficiency reasons
        async.apply(access.copy, { sourcePath: path.join(execDir, executable.dependencies_subdir), targetPath: cookbooksDir }),
        function(callback) {
